...
def index():
    return render_template(
        f'cs50x2025/languages/{os.environ["COURSE_LANGUAGE"]}/psets/1.html',
    )
...
def world():
    ...
    with open(f"app/cs50x2025/content/{os.environ['COURSE_LANGUAGE']}/specifications/world.md", "r") as f:
...
def me():
    ...
    with open(f"app/cs50x2025/content/{os.environ['COURSE_LANGUAGE']}/specifications/me.md", "r") as f:
        markdown_text = f.read()
...
def mario_less():
    with open(f"app/cs50x2025/content/{os.environ['COURSE_LANGUAGE']}/specifications/mario_less.md", "r") as f:
        markdown_text = f.read()
...
def mario_more():
    with open(f"app/cs50x2025/content/{os.environ['COURSE_LANGUAGE']}/specifications/mario_more.md", "r") as f:
        markdown_text = f.read()
...
def cash():
    with open(f"app/cs50x2025/content/{os.environ['COURSE_LANGUAGE']}/specifications/cash.md", "r") as f:
        markdown_text = f.read()
...
def credit():
    with open(f"app/cs50x2025/content/{os.environ['COURSE_LANGUAGE']}/specifications/credit.md", "r") as f:
        markdown_text = f.read()

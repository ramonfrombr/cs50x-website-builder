...
def index():
    return render_template(
        f'cs50x2025/languages/{os.environ["COURSE_LANGUAGE"]}/psets/4.html',
    )
...
def volume():
    with open(f"app/cs50x2025/content/{os.environ['COURSE_LANGUAGE']}/specifications/volume.md", "r") as f:
...
def filter_less():
    with open(f"app/cs50x2025/content/{os.environ['COURSE_LANGUAGE']}/specifications/filter_less.md", "r") as f:
        markdown_text = f.read()
...
def filter_more():
    with open(f"app/cs50x2025/content/{os.environ['COURSE_LANGUAGE']}/specifications/filter_more.md", "r") as f:
        markdown_text = f.read()
...
def recover():
    with open(f"app/cs50x2025/content/{os.environ['COURSE_LANGUAGE']}/specifications/recover.md", "r") as f:
        markdown_text = f.read()

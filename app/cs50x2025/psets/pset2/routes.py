...
def index():
    return render_template(
        f'cs50x2025/languages/{os.environ["COURSE_LANGUAGE"]}/psets/2.html',
    )
...
def scrabble():
    with open(f"app/cs50x2025/content/{os.environ['COURSE_LANGUAGE']}/specifications/scrabble.md", "r") as f:
...
def readability():
    with open(f"app/cs50x2025/content/{os.environ['COURSE_LANGUAGE']}/specifications/readability.md", "r") as f:
        markdown_text = f.read()
...
def caesar():
    with open(f"app/cs50x2025/content/{os.environ['COURSE_LANGUAGE']}/specifications/caesar.md", "r") as f:
        markdown_text = f.read()
...
def substitution():
    with open(f"app/cs50x2025/content/{os.environ['COURSE_LANGUAGE']}/specifications/substitution.md", "r") as f:
        markdown_text = f.read()

...
def index():
    ...
    with open(f"app/web/content/{os.environ['COURSE_LANGUAGE']}/homepage.md", "r") as f:
...
def certificate():
    ...
    with open(f"app/web/content/{os.environ['COURSE_LANGUAGE']}/certificate.md", "r") as f:
        markdown_text = f.read()
...
def syllabus():
    ...
    with open(f"app/web/content/{os.environ['COURSE_LANGUAGE']}/syllabus.md", "r") as f:
        markdown_text = f.read()

...
def index():
    return render_template(
        f'cs50x2025/languages/{os.environ["COURSE_LANGUAGE"]}/psets/6.html',
    )
...
def python_hello():
    with open(f"app/cs50x2025/content/{os.environ['COURSE_LANGUAGE']}/specifications/python_hello.md", "r") as f:
...
def python_mario_less():
    with open(f"app/cs50x2025/content/{os.environ['COURSE_LANGUAGE']}/specifications/python_mario_less.md", "r") as f:
        markdown_text = f.read()
...
def python_mario_more():
    with open(f"app/cs50x2025/content/{os.environ['COURSE_LANGUAGE']}/specifications/python_mario_more.md", "r") as f:
        markdown_text = f.read()
...
def python_cash():
    with open(f"app/cs50x2025/content/{os.environ['COURSE_LANGUAGE']}/specifications/python_cash.md", "r") as f:
        markdown_text = f.read()
...
def python_credit():
    with open(f"app/cs50x2025/content/{os.environ['COURSE_LANGUAGE']}/specifications/python_credit.md", "r") as f:
        markdown_text = f.read()
...
def python_readability():
    with open(f"app/cs50x2025/content/{os.environ['COURSE_LANGUAGE']}/specifications/python_readability.md", "r") as f:
        markdown_text = f.read()
...
def dna():
    with open(f"app/cs50x2025/content/{os.environ['COURSE_LANGUAGE']}/specifications/dna.md", "r") as f:
        markdown_text = f.read()

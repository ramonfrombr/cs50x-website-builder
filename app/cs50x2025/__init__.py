...
cs50x2025.register_blueprint(weeks_bp, url_prefix=f"/{URLS['weeks']}")
cs50x2025.register_blueprint(notes_bp, url_prefix=f"/{URLS['notes']}")
cs50x2025.register_blueprint(psets_bp, url_prefix=f"/{URLS['psets']}")

...
root_routes_template = Template("""from flask import render_template
from . import ${course} as bp
import os
import marko
...
def index():
    ...
    with open(f"app/${course}/content/{os.environ['COURSE_LANGUAGE']}/homepage.md", "r") as f:
...
def certificate():
    ...
    with open(f"app/${course}/content/{os.environ['COURSE_LANGUAGE']}/certificate.md", "r") as f:
        markdown_text = f.read()
...
def syllabus():
    ...
    with open(f"app/${course}/content/{os.environ['COURSE_LANGUAGE']}/syllabus.md", "r") as f:
        markdown_text = f.read()
...
def project():
    with open(f"app/${course}/content/{os.environ['COURSE_LANGUAGE']}/project.md", "r") as f:
        markdown_text = f.read()

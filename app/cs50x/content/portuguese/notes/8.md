...
<html lang="pt">
    <head>
        ...
        <meta
            ...
            content="Introdução às empresas intelectuais de ciência da computação e à arte da programação."
        />
...
-   Essa prática de colocar o estilo e as informações em um único local não é uma boa prática. Podemos mover os elementos de estilo para o topo do arquivo da seguinte forma:
    ...
    <html lang="pt">
        ...
        <body class="centered">
            ...
            <main class="medium">Bem-vindo à minha página inicial!</main>
            <footer class="small">Direitos autorais &#169; John Harvard</footer>
        </body>
    </html>
    ```

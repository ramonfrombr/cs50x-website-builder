...
def index():
    return render_template(
        f'cs50x2025/languages/{os.environ["COURSE_LANGUAGE"]}/psets/5.html',
    )
...
def inheritance():
    with open(f"app/cs50x2025/content/{os.environ['COURSE_LANGUAGE']}/specifications/inheritance.md", "r") as f:
...
def speller():
    with open(f"app/cs50x2025/content/{os.environ['COURSE_LANGUAGE']}/specifications/speller.md", "r") as f:
        markdown_text = f.read()

...
## Control Flow, elif, and else <a id="control-flow-elif-and-else"></a>
...
- Our code can be represented as follows: <pre class="mermaid">
flowchart TD
A([start]) --> B{x < y}
...
- Our code can be illustrated as follows: <pre class="mermaid">
flowchart TD
A([start]) --> B{x == y}
...
## Creating Our Own Parity Function <a id="creating-our-own-parity-function"></a>

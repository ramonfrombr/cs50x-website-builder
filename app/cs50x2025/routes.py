...
@bp.route('/index.html')
def index():
    with open(f"app/cs50x2025/content/{os.environ['COURSE_LANGUAGE']}/homepage.md", "r") as f:
...
def honesty():
    with open(f"app/cs50x2025/content/{os.environ['COURSE_LANGUAGE']}/honesty.md", "r") as f:
        markdown_text = f.read()
...
def certificate():
    with open(f"app/cs50x2025/content/{os.environ['COURSE_LANGUAGE']}/certificate.md", "r") as f:
        markdown_text = f.read()
...
def faqs():
    with open(f"app/cs50x2025/content/{os.environ['COURSE_LANGUAGE']}/faqs.md", "r") as f:
        markdown_text = f.read()
...
def staff():
    with open(f"app/cs50x2025/content/{os.environ['COURSE_LANGUAGE']}/staff.md", "r") as f:
        markdown_text = f.read()
...
def syllabus():
    with open(f"app/cs50x2025/content/{os.environ['COURSE_LANGUAGE']}/syllabus.md", "r") as f:
        markdown_text = f.read()
...
def project():
    with open(f"app/cs50x2025/content/{os.environ['COURSE_LANGUAGE']}/project.md", "r") as f:
        markdown_text = f.read()
...
def style():
    with open(f"app/cs50x2025/content/{os.environ['COURSE_LANGUAGE']}/style.md", "r") as f:
        markdown_text = f.read()

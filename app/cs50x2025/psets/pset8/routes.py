...
def index():
    return render_template(
        f'cs50x2025/languages/{os.environ["COURSE_LANGUAGE"]}/psets/8.html',
    )
...
def trivia():
    with open(f"app/cs50x2025/content/{os.environ['COURSE_LANGUAGE']}/specifications/trivia.md", "r") as f:
...
def homepage():
    with open(f"app/cs50x2025/content/{os.environ['COURSE_LANGUAGE']}/specifications/homepage.md", "r") as f:
        markdown_text = f.read()

...
def index():
    return render_template(
        f'cs50x2025/languages/{os.environ["COURSE_LANGUAGE"]}/psets/9.html',
    )
...
def birthdays():
    with open(f"app/cs50x2025/content/{os.environ['COURSE_LANGUAGE']}/specifications/birthdays.md", "r") as f:
...
def finance():
    with open(f"app/cs50x2025/content/{os.environ['COURSE_LANGUAGE']}/specifications/finance.md", "r") as f:
        markdown_text = f.read()

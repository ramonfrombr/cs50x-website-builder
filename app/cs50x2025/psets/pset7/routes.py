...
def index():
    return render_template(
        f'cs50x2025/languages/{os.environ["COURSE_LANGUAGE"]}/psets/7.html',
    )
...
def songs():
    with open(f"app/cs50x2025/content/{os.environ['COURSE_LANGUAGE']}/specifications/songs.md", "r") as f:
...
def movies():
    with open(f"app/cs50x2025/content/{os.environ['COURSE_LANGUAGE']}/specifications/movies.md", "r") as f:
        markdown_text = f.read()
...
def fiftyville():
    with open(f"app/cs50x2025/content/{os.environ['COURSE_LANGUAGE']}/specifications/fiftyville.md", "r") as f:
        markdown_text = f.read()

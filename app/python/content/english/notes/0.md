...
## Creating Code with Python <a id="creating-code-with-python"></a>
...
## Improving Your First Python Program <a id="improving-your-first-python-program"></a>
...
## Further Improving Your First Python Program <a id="further-improving-your-first-python-program"></a>
...
## Strings and Paremeters <a id="strings-and-paremeters"></a>
...
### A small problem with quotation marks <a id="a-small-problem-with-quotation-marks"></a>
...
## Formatting Strings <a id="formatting-strings"></a>
...
## More on Strings <a id="more-on-strings"></a>
...
## Integers or int <a id="integers-or-int"></a>
...
## Readability Wins <a id="readability-wins"></a>
...
## Float Basics <a id="float-basics"></a>
...
## More on Floats <a id="more-on-floats"></a>

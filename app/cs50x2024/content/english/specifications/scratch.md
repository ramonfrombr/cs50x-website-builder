...
<div class="alert alert-info" data-alert="info" role="alert"><p>For this problem, it is <strong>reasonable</strong> to submit a Scratch project that you have previously submitted to another CS50 course, so long as it meets the above requirements.</p></div>
...
<div class="alert alert-warning" data-alert="warning" role="alert"><p>Be sure to complete <strong>both</strong> steps below, in order!</p></div>
...
<div class="alert alert-warning" data-alert="warning" role="alert"><p>If you encounter the error “No files in this directory are expected by cs50/problems/2024/x/scratch”, please make sure your scratch project file name indeed ends with <code class="language-plaintext highlighter-rouge">.sb3</code>!</p></div>

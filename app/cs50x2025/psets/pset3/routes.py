...
def index():
    return render_template(
        f'cs50x2025/languages/{os.environ["COURSE_LANGUAGE"]}/psets/3.html',
    )
...
def sort():
    with open(f"app/cs50x2025/content/{os.environ['COURSE_LANGUAGE']}/specifications/sort.md", "r") as f:
...
def plurality():
    with open(f"app/cs50x2025/content/{os.environ['COURSE_LANGUAGE']}/specifications/plurality.md", "r") as f:
        markdown_text = f.read()
...
def runoff():
    with open(f"app/cs50x2025/content/{os.environ['COURSE_LANGUAGE']}/specifications/runoff.md", "r") as f:
        markdown_text = f.read()
...
def tideman():
    with open(f"app/cs50x2025/content/{os.environ['COURSE_LANGUAGE']}/specifications/tideman.md", "r") as f:
        markdown_text = f.read()

...
<div class="alert alert-warning" data-alert="warning" role="alert"><p>O CS50W não possui uma correspondência direta entre palestras e projetos. Se você está tentando fazer este projeto sem ter assistido pelo menos a Aula 5, você está tentando fazer isso cedo demais!</p></div>

...
psets_routes_template = Template("""from flask import Blueprint, render_template
...
def pset0_project():
    ...
    with open(f"app/${course}/content/{os.environ['COURSE_LANGUAGE']}/specifications/pset0_project.md", "r") as f:
...
def pset1_project():
    ...
    with open(f"app/${course}/content/{os.environ['COURSE_LANGUAGE']}/specifications/pset1_project.md", "r") as f:
        markdown_text = f.read()
...
def pset2_project():
    with open(f"app/${course}/content/{os.environ['COURSE_LANGUAGE']}/specifications/pset2_project.md", "r") as f:
        markdown_text = f.read()
...
def pset3_project():
    with open(f"app/${course}/content/{os.environ['COURSE_LANGUAGE']}/specifications/pset3_project.md", "r") as f:
        markdown_text = f.read()
...
def pset4_project():
    with open(f"app/${course}/content/{os.environ['COURSE_LANGUAGE']}/specifications/pset4_project.md", "r") as f:
        markdown_text = f.read()
...
def pset5_project():
    with open(f"app/${course}/content/{os.environ['COURSE_LANGUAGE']}/specifications/pset5_project.md", "r") as f:
        markdown_text = f.read()
...
def pset6_project():
    with open(f"app/${course}/content/{os.environ['COURSE_LANGUAGE']}/specifications/pset6_project.md", "r") as f:
        markdown_text = f.read()
...
def pset7_project():
    with open(f"app/${course}/content/{os.environ['COURSE_LANGUAGE']}/specifications/pset7_project.md", "r") as f:
        markdown_text = f.read()
...
def pset8_project():
    with open(f"app/${course}/content/{os.environ['COURSE_LANGUAGE']}/specifications/pset8_project.md", "r") as f:
        markdown_text = f.read()
...
def pset9_project():
    with open(f"app/${course}/content/{os.environ['COURSE_LANGUAGE']}/specifications/pset9_project.md", "r") as f:
        markdown_text = f.read()

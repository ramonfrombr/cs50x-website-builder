...
english_notes_dir = os.listdir("./app/cs50x2025/content/english/notes")
...
def translate_page_by_sections(files, page):
    ...
    destination_file = open(
        f"./app/cs50x2025/content/{language}/notes/{page}.md", "w")

    for file in files:
        source_text = open(
            f"./app/cs50x2025/content/english/notes/{file}").read()
        ...
        try:
            ...
            destination_file = open(
                f"./app/cs50x2025/content/{language}/notes/{page}.md", "a")
